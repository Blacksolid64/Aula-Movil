    ...
    <center>
        ...
        <asp:GridView ID="GR_Courses" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Dia de la semana">
                    <ItemTemplate>
                        <asp:Label ID="lbl_DiaSem" runat="server" Text='<%# Eval("diaSemana") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_DiaSem" runat="server" Text='<%# Eval("diaSemana") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
            <tr>
                ...
                <td>
                    <asp:Button ID="btnAnnadir" runat="server" Text="Insertar" OnClick="agregarCursos" />
                </td>
            </tr>
        </table>
        <hr/>
